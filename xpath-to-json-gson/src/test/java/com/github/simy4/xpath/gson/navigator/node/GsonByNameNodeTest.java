...
public class GsonByNameNodeTest {
    ...
    public void shouldSetElementByIndexOnSet() {
        ...
        assertThat(jsonObject.entrySet()).containsExactly(
                new AbstractMap.SimpleEntry<>("one", new JsonPrimitive(1)),
                new AbstractMap.SimpleEntry<>("two", new JsonPrimitive(4)),
                new AbstractMap.SimpleEntry<>("three", new JsonPrimitive(3))
        );
    }
