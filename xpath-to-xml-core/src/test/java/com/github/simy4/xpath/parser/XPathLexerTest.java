  ...
  static Stream<Arguments> data() {
    ...
    return Stream.of(
        arguments(
            "./author",
            List.of(
                token(Type.DOT, "."), token(Type.SLASH, "/"), token(Type.IDENTIFIER, "author"))),
        arguments("author", List.of(token(Type.IDENTIFIER, "author"))),
        arguments("first.name", List.of(token(Type.IDENTIFIER, "first.name"))),
        arguments(
            "/bookstore", List.of(token(Type.SLASH, "/"), token(Type.IDENTIFIER, "bookstore"))),
        arguments(
        ...
        arguments(
            "*/*", List.of(token(Type.STAR, "*"), token(Type.SLASH, "/"), token(Type.STAR, "*"))),
        arguments(
            "*[@specialty]",
            List.of(
                token(Type.STAR, "*"),
        ...
        arguments(
            "my:*",
            List.of(token(Type.IDENTIFIER, "my"), token(Type.COLON, ":"), token(Type.STAR, "*"))),
        arguments(
            "@my:*",
            List.of(
                token(Type.AT, "@"),
