...
public class GreaterThanTest {
    ...
    public void shouldResolveToTrueWhenLeftIsGreaterThanRight(@FromDataPoints("less") View<String> less,
        ...
        // when
        View<String> result = Operator.greaterThan.resolve(context, greater, less);
    ...
    public void shouldResolveToFalseWhenLeftIsLessThanRight(@FromDataPoints("less") View<String> less,
        ...
        // when
        View<String> result = Operator.greaterThan.resolve(context, less, greater);
    ...
    public void shouldResolveToFalseWhenLeftIsEqualToRight(@FromDataPoints("less") View<String> left,
        ...
        // when
        View<String> result = Operator.greaterThan.resolve(context, left, right);
