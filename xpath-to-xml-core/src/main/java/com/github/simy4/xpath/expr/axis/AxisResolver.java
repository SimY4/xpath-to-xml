...
public interface AxisResolver {
     ...
     */
    <N extends Node> IterableNodeView<N> resolveAxis(Navigator<N> navigator, NodeView<N> parent, boolean greedy)
     ...
     * @throws XmlBuilderException if error occur during XML node creation
     */
    <N extends Node> NodeView<N> createAxisNode(Navigator<N> navigator, NodeView<N> parent, int position)
            throws XmlBuilderException;
