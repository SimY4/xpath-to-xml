...
import com.github.simy4.xpath.json.navigator.JsonJsonNavigator;
...
public class JsonJsonNavigatorSpi implements NavigatorSpi {
  ...
  public <T> T process(T json, Iterable<Effect> effects) throws XmlBuilderException {
    ...
    final JsonJsonNode root = new JsonJsonRootNode(json);
    final Navigator<JsonJsonNode> navigator = new JsonJsonNavigator(root);
