...
class JDomNavigatorTest {
    ...
    void testParentOfRegularNode() {
        assertThat(navigator.parentOf(new JDomElement(xml))).hasFieldOrPropertyWithValue("node", parent);
    }
    ...
    void testCreateElementFailure() {
        assertThatThrownBy(() -> navigator.createElement(new JDomAttribute(new Attribute("attr", "")),
                new QName("elem")))
                .isInstanceOf(XmlBuilderException.class);
    }
